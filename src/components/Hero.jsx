            ...
            <div className='container ma-auto px-6 flex flex-col md:flex-row items-center justify-between'>
                ...
                <div className='md:w-1/2 mb-10 md:mb-0'>
                    ...
                    <h2 className='text-2xl md:text-4xl font-semibold mb-6 typewriter'>
                        Java Developer & Problem Solver</h2>
                    <p className='text-lg text-gray-300 mb-6'> I build practical software solutions with Java, 
                        Spring Boot,and modern backend technologies — turning problems into
